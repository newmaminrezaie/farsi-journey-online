  ...
  return (
    <>
      ...
      <section className="container py-20">
        <SectionHeader eyebrow="کلاس‌های جاری" title="در حال ثبت‌نام" note="تازه‌ترین کلاس‌های افزوده‌شده — فهرست کامل در صفحه کلاس‌ها" />
      ...
      <RelatedLinks
        title="مسیرهای پیشنهادی برای شما"
        links={[
          { to: "/semesters", label: "کلاس‌های در حال ثبت‌نام زبان انگلیسی", desc: "فهرست کامل دوره‌های حضوری و آنلاین گویا با برنامه و شهریه." },
          ...
          { to: "/contact", label: "تماس با آموزشگاه زبان گویا", desc: "آدرس غفاری ۶، تلفن و راه‌های ارتباطی." },
        ]}
      />
