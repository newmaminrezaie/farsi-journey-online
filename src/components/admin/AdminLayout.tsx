...
import { LayoutDashboard, BookOpen, GraduationCap, Users, UserCog, ShoppingBag, ClipboardList, Megaphone, Bell, Images, BadgePercent, KeyRound, FileSpreadsheet, LogOut, AlertTriangle } from "lucide-react";
...
const links = [
  ...
  { to: "/admin/import", label: "ورود اطلاعات از فایل", icon: FileSpreadsheet },
